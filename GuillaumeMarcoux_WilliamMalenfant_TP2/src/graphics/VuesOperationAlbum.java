			...
			public void actionPerformed(ActionEvent e){
				...
				try{
					...
					case AJOUTER:
						...
						ResultSet allAlbumForTitles = database.selectEverythingFrom(Album.TABLE_NAME);
						
						Object[] albumsTitles = database
								.getAllContentOfColumn(allAlbumForTitles, Album.COLUMN_NAMES[Album.COLUMN_TITLE]);
						...
						if(!hasConfirmed){
							...
							JOptionPane.showMessageDialog(VuesOperationAlbum.this,
											"Un album ayant ce titre existe déjà!", COMMON_ERROR,
