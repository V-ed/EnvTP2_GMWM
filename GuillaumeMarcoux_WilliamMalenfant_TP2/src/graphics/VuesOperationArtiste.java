...
public class VuesOperationArtiste extends JDialog implements Constantes, ConstantesAffichage {
	...
	public VuesOperationArtiste(MySQLDatabase database, JDialog parentFrame, int typeOperation, Artiste artiste) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					case MODIFIER:
						...
						artiste.modifyItem(nom, prenom, estMembre.isSelected(), null);
