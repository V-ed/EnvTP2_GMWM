...
public class VueConnexion extends JFrame implements Constantes, ConstantesAffichage, WindowListener {
	...
	public VueConnexion() {
		...
		lblUsername.setIcon(OutilsFichiers.getImageIconFromResources("utilisateur.png"));
		...
		lblPassword.setIcon(OutilsFichiers.getImageIconFromResources("cle.png"));
		...
		btnValider.setIcon(OutilsFichiers.getImageIconFromResources("crochet_1.png"));

		btnValider.setBounds(90, 160, 100, 30);
		contentPane.add(btnValider);
		btnQuitter.setIcon(OutilsFichiers.getImageIconFromResources("croix_1.png"));
		...
		btnValider.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					MySQLDatabase database = new MySQLDatabase("localhost", "gestionalbums", getUsername(),
							getPassword());
					...
					JOptionPane.showMessageDialog(null, ERROR_IMPOSSIBLE_CONNECTION, TITLE_ERROR_CONNECTION,
